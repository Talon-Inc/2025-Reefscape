...
public class ElevatorToAlgae1 extends Command {
  private final Elevator elevator;
  private final double position = 0.1337;

  /** Creates a new ElevatorToAlgae1. */
  public ElevatorToAlgae1(Elevator elevator) {
